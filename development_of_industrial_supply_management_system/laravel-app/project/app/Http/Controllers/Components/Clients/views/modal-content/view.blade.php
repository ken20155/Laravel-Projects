...
<div class="row">
  <div class="col-md-12">
    ...
    <input type="text" class="form-control" id="validationDefault01" name = "company_name" value = "<?= $data ? $data->company_name : '' ?>" required>
  </div>
  {{-- <div class="col-md-4">
    <label for="validationDefault02" class="form-label">Middle name</label>
    <input type="text" class="form-control" id="validationDefault02" name = "middle_name" value = "<?= $data ? $data->com_name : '' ?>" required>
  </div>
  <div class="col-md-4">
    <label for="validationDefault02" class="form-label">Last name</label>
    <input type="text" class="form-control" id="validationDefault02" name = "last_name" value = "<?= $data ? $data->com_name : '' ?>" required>
  </div> --}}
</div>
<div class="row">
  <div class="col-md-4">
