  <div class="row">
    <div class="col-sm-6">
      <h3 class="mb-0 font-weight-bold">TEST</h3>
            ...
            <table class="table">
              <tbody>
                <tr>
                  <td>
                    <div class="d-flex">
                      <img class="img-sm rounded-circle mb-md-0 mr-2" src="<?=env('APP_URL')?>public/plugins/images/faces/face30.png" alt="profile image">
                      <div>
                        <div> Company</div>
                ...
                <tr>
                  <td>
                    <div class="d-flex">
                      <img class="img-sm rounded-circle mb-md-0 mr-2" src="<?=env('APP_URL')?>public/plugins/images/faces/face31.png" alt="profile image">
                      <div>
                        <div> Company</div>
                ...
                <tr>
                  <td>
                    <div class="d-flex">
                      <img class="img-sm rounded-circle mb-md-0 mr-2" src="<?=env('APP_URL')?>public/plugins/images/faces/face32.png" alt="profile image">
                      <div>
                        <div> Company</div>
                ...
                <tr>
                  <td>
                    <div class="d-flex">
                      <img class="img-sm rounded-circle mb-md-0 mr-2" src="<?=env('APP_URL')?>public/plugins/images/faces/face33.png" alt="profile image">
                      <div>
                        <div> Company</div>
                ...
                <tr>
                  <td>
                    <div class="d-flex">
                      <img class="img-sm rounded-circle mb-md-0 mr-2" src="<?=env('APP_URL')?>public/plugins/images/faces/face34.png" alt="profile image">
                      <div>
                        <div> Company</div>
                        <div class="font-weight-bold  mt-1">volkswagen</div>
                      </div>
