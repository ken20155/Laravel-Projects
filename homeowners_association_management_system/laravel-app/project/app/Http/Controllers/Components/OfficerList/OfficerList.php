<?php 
namespace App\Http\Controllers\Components\OfficerList;
            ...
            foreach ($result as $key => $R) {
                ...
                $data[] = [
                 ...
                 'action' => '
                         ...
                         <a class="dropdown-item" href="javascript:void(0);" '.$crdentials.' id = "viewAccount"><i class="mdi mdi-pen"></i> Edit</a>
                         <a class="dropdown-item" href="javascript:void(0);" '.$crdentials.' id = "deleteData"><i class="mdi mdi-close-circle"></i>  Delete</a>
                         </div>
                 ',
                ];
             }
