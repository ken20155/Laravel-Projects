...
<div class="row">
  ...
  <div class="col-md-6">
    <label for="validationDefault01" class="form-label">Lot No.</label>
    <input type="text" class="form-control" id="validationDefault01" name = "lot_no" value = "<?= $data ? $data->lot_no : '' ?>" required>
  </div>
  <div class="col-md-6">
    <label for="validationDefault02" class="form-label">Block No.</label>
    <input type="text" class="form-control" id="validationDefault02" name = "block_no" value = "<?= $data ? $data->block_no : '' ?>" required>
  </div>
</div>
<div class="row">
    <div class="col-md-6">
