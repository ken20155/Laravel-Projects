...
class MainController extends Controller
{
    ...
    public function getContent($params){
        ...
        if(method_exists($componentsClassRender, $componentsController)) {
            ...
            $data['title']  =  $menu['selected_menu']->title;//str_replace(' ', ' ', ucwords(str_replace('-', ' ', $params)));
    ...
    public function fileDelete(){
        ...
        $data['deleted'] = 1;
        $where = [
                    ['field' => 'file_id','value'=> $get['key']]
                ];
        $res = $this->model->updateWhere('tbl_files_source', $where, $data);
        return true;
    }
