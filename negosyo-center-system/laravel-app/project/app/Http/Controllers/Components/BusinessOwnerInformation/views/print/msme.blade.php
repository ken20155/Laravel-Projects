        ...
        <table class="table-custom inline-table" style="width:100%">
            <tbody>
                <tr>
                    ...
                    <td style="border-bottom: none !important;text-align:center"><?= $personal_info->first_name ?></td>
                    <td style="border-bottom: none !important;text-align:center"><?= $personal_info->last_name ?></td>
                    <td style="border-bottom: none !important;text-align:center"><?= $personal_info->middle_name ?></td>
                    <td style="border-bottom: none !important;text-align:center"><?= $personal_info->suffix ?></td>
                </tr>
                <tr >
        ...
        <table class="table-custom inline-table" style="width:100%">
            <tbody>
                ...
                <tr>
                    ...
                    <th><?= checkFieldIfExist($data,'category_entrepreneur','checkbox','Unemployeed') ?>Unemployeed</th>
                </tr>
                <tr>
