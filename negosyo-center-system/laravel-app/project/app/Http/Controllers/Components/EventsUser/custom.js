$(document).ready(function() {
    ...
    var columns = [
        ...
        { data: 'event_status', title: 'Event status' },
...
$(document).on('click', '#addNewAccount', function() {
    ...
    request.done(function(response) {
        ...
        main.unblock_ui();
        console.log(response.data_events)
        ...
        $('#calendar').fullCalendar({
            ...
            eventClick: function(event, jsEvent, view) {
                if (event.status == 'NOT AVAILABLE') {
                        main.msg('You already applied to this event','error','');
                }else{
                    var data = $.param({
                        id:event.id,
                        status:event.status,
...
$(document).on('submit', '#submit-form', function(event) {
    ...
    if (event_id != '') {
        ...
        main.msg('Please Select Event','error','');
    }
