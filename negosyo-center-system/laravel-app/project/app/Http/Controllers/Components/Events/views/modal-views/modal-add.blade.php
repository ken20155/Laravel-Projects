...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <input type="date" value="<?= $date ?>" name = "date" class="form-control form-control-sm" id="validationCustom01" min="<?= date(SQLDATE) ?>" readonly required>
    </div>
    <div class="col-md-4">
                    ...
                    if ($participants) {
                        ...
                        foreach ($participants as $key => $R) {
                            ...
                            <tr>
                                ...
                                <td><?= $R->attendance ?></td>
                                <td>
                                    <textarea class = "form-control" name="" id="" cols="30" rows="2" readonly><?= $R->reason_cancel ?></textarea>
                                </td>
                                <td>
