<?php 
namespace App\Http\Controllers\Components\BusinessInformation;
...
class BusinessInformation 
{
    ...
    function __construct() {
        ...
        Helpers::getView('BusinessInformation');
    }
    ...
    public function openDynamicModal(){
        ...
        return [
            ...
            'action_fn' => $action_fn,
            'body' =>   $this->session['user_role'] == 2 ? view('modal-views.modal-add', $d)->render() : view('modal-views.modal-admin-view', $d)->render(),
            'footer' => $footer,
        ];
    }
