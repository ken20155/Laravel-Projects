        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">
                  <?php 
                  if (!$msg) {
                    echo '<button type="button" class="btn btn-sm btn-primary" id="addNewAccount">Add New</button>';
                  }else{
                    echo '<button type="button" class="btn btn-sm btn-primary" data-msg = "'.$msg.'" id="addNewAccountDisabled">Add New</button>';
                  } 
                  ?>
                    
                    <button type="button" class="btn btn-sm btn-info" id="refreshBtn">Refresh</button>
                </h4>
                <i class="text-danger">NOTE: Business owners are eligible for a business loan upon obtaining a 1-year membership in the Negosyo Center, offering vital support and resources to foster growth.*</i>
            </div>
            <div class="card-body">
