        ...
        <div class="mb-3 row">
            ...
            <div class="col-8">
                <div class="input-group input-group-sm mb-3">
                    <input type="text" value = "<?= $attachement1 ?>" id ="file-name-<?= $file_num1 ?>" class="form-control" readonly>
                    <input <?= $required ?> type="file" name="attactment<?= $file_num1 ?>" class="specific-file-input" id="attachment-<?= $file_num1 ?>">
                    <button class="btn btn-outline-secondary d-none" type="button" id="upload-attachment" data-num="<?= $file_num1 ?>">Upload File</button>
            ...
            <label for="inputPassword" class="col-4 col-form-label">SIGNAGE (<i>PICTURE</i>)</label>
             <div class="col-8">
                <div class="input-group input-group-sm mb-3">
                    <input type="text" value = "<?= $attachement2 ?>" id ="file-name-<?= $file_num2 ?>" class="form-control" readonly>
                    <input <?= $required ?> type="file" name="attactment<?= $file_num2 ?>" class="specific-file-input" id="attachment-<?= $file_num2 ?>">
                    <button class="btn btn-outline-secondary d-none" type="button" id="upload-attachment" data-num="<?= $file_num2 ?>">Upload File</button>
            ...
            <label for="inputPassword" class="col-4 col-form-label">DTI and BUSINESS PERMIT</label>
             <div class="col-8">
                <div class="input-group input-group-sm mb-3">
                    <input type="text" value = "<?= $attachement3 ?>" id ="file-name-<?= $file_num3 ?>" class="form-control" readonly>
                    <input <?= $required ?> type="file" name="attactment<?= $file_num3 ?>" class="specific-file-input" id="attachment-<?= $file_num3 ?>">
                    <button class="btn btn-outline-secondary d-none" type="button" id="upload-attachment" data-num="<?= $file_num3 ?>">Upload File</button>
            ...
            <label for="inputPassword" class="col-4 col-form-label">INVENTORY (<i>PICTURE</i>)</label>
             <div class="col-8">
                <div class="input-group input-group-sm mb-3">
                    <input type="text" value = "<?= $attachement4 ?>" id ="file-name-<?= $file_num4 ?>" class="form-control" readonly>
                    <input <?= $required ?> type="file" name="attactment<?= $file_num4 ?>" class="specific-file-input" id="attachment-<?= $file_num4 ?>">
                    <button class="btn btn-outline-secondary d-none" type="button" id="upload-attachment" data-num="<?= $file_num4 ?>">Upload File</button>
            ...
            <label for="inputPassword" class="col-4 col-form-label">FIX ASSET (<i>PICTURE</i>)</label>
             <div class="col-8">
                <div class="input-group input-group-sm mb-3">
                    <input type="text" value = "<?= $attachement5 ?>" id ="file-name-<?= $file_num5 ?>" class="form-control" readonly>
                    <input <?= $required ?> type="file" name="attactment<?= $file_num5 ?>" class="specific-file-input" id="attachment-<?= $file_num5 ?>">
                    <button class="btn btn-outline-secondary d-none" type="button" id="upload-attachment" data-num="<?= $file_num5 ?>">Upload File</button>
            ...
            <div class="col-5">
                <div class="input-group input-group-sm mb-3">
                    <input type="text" value = "<?= $attachement6 ?>" id ="file-name-<?= $file_num6 ?>" class="form-control" readonly>
                    <input <?= $required ?> type="file" name="attactment<?= $file_num6 ?>" class="specific-file-input" id="attachment-<?= $file_num6 ?>">
                    <button class="btn btn-outline-secondary d-none" type="button" id="upload-attachment" data-num="<?= $file_num6 ?>">Upload File</button>
