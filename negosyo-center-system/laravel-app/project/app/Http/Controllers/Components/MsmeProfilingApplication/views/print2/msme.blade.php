        ...
        <table class="table-custom inline-table" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-6"><?= $user_details_session->civil_status == 'Legally separated' ?  '🗹' : '◻' ?> Single</div>
                            <div class="col-6"> <?= $user_details_session->civil_status == 'Single' ?  '🗹' : '◻' ?> Married</div>
                            <div class="col-6"><?= $user_details_session->civil_status == 'Married' ?  '🗹' : '◻' ?> Widowed</div>
                            <div class="col-6"><?= $user_details_session->civil_status == 'Widowed' ?  '🗹' : '◻' ?> Legally Separated</div>
                        </div>
                    </td>
                    <td>
                        <div class="row">
