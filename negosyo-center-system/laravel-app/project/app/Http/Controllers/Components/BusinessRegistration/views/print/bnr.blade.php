    ...
    <div class="" style="width:100%;min-width: 1000">
        ...
        <table class="table-custom inline-table" style="width:100%">
            <tbody>
                ...
                <tr>
                    <td>14. <?= checkFieldIfExist($data,'business_name_1') ?>
                    </td>
        ...
        <table class="table-custom inline-table" style="width:100%">
            <tbody>
                ...
                <tr>
                    ...
                    <td>24. Mobile no.<br>
                        <?= checkFieldIfExist($data,'business_mobile_no') ?>
                    </td>
                </tr>
            </tbody>
        </table>
        <table class="table-custom inline-table" style="width:100%">
            <tbody>
                ...
                <tr>
                    <td>
                        <?= checkFieldIfExist($data,'is_same','checkbox','1') ?>
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width:30%">27. Barangay:<br>
                        <?= checkFieldIfExist($data,'owner_details_brgy') ?>
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>31. Phone no.: (Area Code):<br>
                        <?= checkFieldIfExist($data,'owner_details_phone_no') ?>
                    </td>
                    <td>32. Mobile no.:<br>
