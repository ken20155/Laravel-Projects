...
class Helpers {
    ...
    public static function menu($params){
        ...
        return [
            ...
            'get_menu_directory'    => Self::getMenuDirectory($selected_menu->menu_id),
    ...
    public static function segregateDate($data) {
        if ($data != '' && $data != null) {
            $carbonDate = Carbon::parse($data);
            $converted['year'] = $carbonDate->year;    
            $converted['month'] = $carbonDate->month;  
            $converted['day'] = $carbonDate->day;     
            return $converted;
        }else{
            return '';
        }
