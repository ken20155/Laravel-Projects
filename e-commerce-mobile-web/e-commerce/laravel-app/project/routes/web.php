...
//user
Route::any('user-component/view/{param1}', [MainController::class, 'getContentUser']);
Route::any('user-component/run/{param1}/{param2}', [MainController::class, 'runUserComponentFunction']);



Route::any('pages/{param1}', [MainController::class, 'getPublicPages']);
Route::get('/{app}/{module}/js/custom', [MainController::class, 'serveCustomJS'])->name('js.custom');
