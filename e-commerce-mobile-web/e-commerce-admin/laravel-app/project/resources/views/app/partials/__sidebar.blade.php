...
<div class="left-side-bar">
  <div class="brand-logo">
    <a href="index.html">
      <img src="<?= env('APP_URL') ?>public/plugins/vendors/images/deskapp-logo.svg" alt="" class="dark-logo" />
      <img
        src="<?= env('APP_URL') ?>public/plugins/vendors/images/deskapp-logo-white.svg"
        alt=""
        class="light-logo"
      />
    </a>
  ...
  <div class="menu-block customscroll">
    <div class="sidebar-menu">
      <ul id="accordion-menu">
        ...
        <li>
          <a href="payment" class="dropdown-toggle no-arrow">
