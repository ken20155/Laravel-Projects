<style>
  ...
  .table th,
.table td {
    font-size: 14px; /* Adjusts font size for table cells */
...
<div class="row">
  <div class="col-8">
      <div style="border: 1px solid rgb(35, 27, 27);padding:20px;border-radius:10px;">
        ...
        <div class="row" id="generateStockProducts" style="font-size: 10px; !important">
  ...
  <div class="col-4">
    <div style="border: 1px solid rgb(35, 27, 27);padding:20px;border-radius:10px;">
      <table class="table">
        <thead>
          <tr>
            <th scope="col" style="width:30%;font-size: 10px; !important">Product</th>
            <th scope="col"  style="width:50%;font-size: 10px; !important"class="text-center">QTY</th>
            <th scope="col"  style="width:20%;font-size: 10px; !important"class="text-right">Price / Each</th>
            <th scope="col"  style="width:25%;font-size: 10px; !important"class="text-right">Sub Total</th>
            <th scope="col" style="width:5%;font-size: 10px; !important"></th>
          </tr>
        </thead>
        <tbody id="generateStockProductsSelected">
