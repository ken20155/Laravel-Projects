    ...
    foreach ($data as $key => $R) {
        ...
        <div class="col-2" style="padding-left: 10px !important;padding-right: 0px !important">
            ...
            ">
                    ...
                    <strong class="card-text" style="font-size: 12px;">Stocks: <?= $R->total_stocks ?></strong><br>
                    <strong class="card-texts" style="font-size: 13px; font-weight: bold;">Price: <?= number_format($R->price,2) ?></strong>
                    
                <p class="text-center mt-1">
                  <button type="button"
                   style="width:40px; font-size:8px; padding:2px 4px;"
                  class="btn btn-primary addToCart" id="" data-stockid="<?= $R->stock_id ?>" data-productid="<?= $R->product_id ?>" data-price="<?= $R->price ?>"
