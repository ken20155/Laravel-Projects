$(document).ready(function() {
    $(document).ready(function() {
        ...
        function generateMainTable(data) {
            ...
            var columns = [
                ...
                { data: 'return_stocks', title: 'Return Stocks' },
                { data: 'dis_stocks', title: 'Distributed Stocks' },
    ...
    $(document).on('click', '.viewStockReturn', function() {
        ...
        var url = getRunURL('viewStockReturn');
        var request = main.form_ajax(url, data, 'POST', function(xhr) {
           main.block_ui();
        });
        request.done(function(response) {
